...
*/
static FILE *fp = NULL; 
 /** @var static int useBinary
		 tells whether we should use binary.
	*/
static int useBinary = 0; 
 /** @var static int numInColumn
		 number of character in line.
 */
