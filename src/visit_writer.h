...
/** write_point_mesh: Writes out a point mesh.
*
* @param filename   The name of the file to write.  If the extension ".vtk" is
*                   not present, it will be added.
* @param useBinary  '0' to write ASCII, !0 to write binary
* @param npts       The number of points in the mesh.
* @param pts        The spatial locations of the points.  This array should
*                   be size 3*npts.  The points should be encoded as:
*                   <x1, y1, z1, x2, y2, z2, ..., xn, yn, zn>
* @param nvars      The number of variables.
* @param vardim     The dimension of each variable.  The size of vardim should
*                   be nvars.  If var i is a scalar, then vardim[i] = 1.
*                   If var i is a vector, then vardim[i] = 3.
* @param vars       An array of variables.  The size of vars should be nvars.
...
/**  write_unstructured_mesh: Writes out a unstructured mesh.
*     
*  
* @param filename   The name of the file to write.  If the extension ".vtk" is
*                   not present, it will be added.
...
* @param conn       The connectivity array.
* @param nvars      The number of variables.
* @param vardim     The dimension of each variable.  The size of vardim should
*                   be nvars.  If var i is a scalar, then vardim[i] = 1.
*                   If var i is a vector, then vardim[i] = 3.
* @param centering  The centering of each variable.  The size of centering 
...
/**  write_regular_mesh: Writes out a regular mesh.
*
*		   A regular mesh is one where the data lies
...
*                    not present, it will be added.
* @param  useBinary  '0' to write ASCII, !0 to write binary
* @param  dims       An array of size 3 = { nX, nY, nZ }, where nX is the
...
/**  void write_rectilinear_mesh:  Writes out a rectilinear mesh.
*     
*
* @param filename   The name of the file to write.  If the extension ".vtk" is
*                   not present, it will be added.
...
* @param dims       An array of size 3 = { nX, nY, nZ }, where nX is the
*                   number of points in the X-dimension, etc.
* @param x          An array of size dims[0] that contains the x-coordinates.
* @param y          An array of size dims[1] that contains the x-coordinates.
* @param z          An array of size dims[2] that contains the x-coordinates.
* @param nvars      The number of variables.
* @param vardim     The dimension of each variable.  The size of vardim should
*                   be nvars.  If var i is a scalar, then vardim[i] = 1.
*                   If var i is a vector, then vardim[i] = 3.
...
/**   write_curvilinear_mesh: Writes out a curvilinear mesh.
*     
*  @param  filename   The name of the file to write.  If the extension ".vtk" is
*                     not present, it will be added.
*  @param  useBinary  '0' to write ASCII, !0 to write binary
*  @param  dims       An array of size 3 = { nI, nJ, nK }, where nI is the
*                     number of points in the logical I dimension, etc.
*  @param  pts        An array of size nI*nJ*nK*3.  The array should be layed
